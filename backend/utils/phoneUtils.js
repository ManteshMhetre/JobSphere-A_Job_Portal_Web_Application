...
// Check if exactly 10 digits
    ...
    throw new Error('Invalid Indian phone number. It must be 10 digits and start with 6, 7, 8, or 9.');
    }
...
export function formatPhoneForDisplay(phone) {
    ...
    if (phoneStr.length === 10) {
        ...
        return `+${phoneStr.slice(0, phoneStr.length - 10)} ${phoneStr.slice(-10, -6)} ${phoneStr.slice(-6)}`;
    }
