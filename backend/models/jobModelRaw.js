...
export const JobModel = {
    ...
    async create(jobData) {
        const {
            ...
            hiringMultipleCandidates, personalWebsiteTitle, personalWebsiteUrl,
            jobNiche, postedBy
        } = jobData;
        ...
        const values = [
            title, jobType, location, companyName, introduction || null,
            responsibilities, qualifications, offers || null, salary,
            hiringMultipleCandidates || 'No', personalWebsiteTitle || null, 
            personalWebsiteUrl || null, jobNiche, postedBy
        ];
    ...
    validateJobData(jobData) {
        ...
        if (!jobData.jobType || !['Full-time', 'Part-time'].includes(jobData.jobType)) {
        ...
        if (!jobData.responsibilities || jobData.responsibilities.trim().length === 0) {
