...
export const UserModel = {
    ...
    async create(userData) {
        ...
        const values = [
            ...
            firstNiche || null, secondNiche || null, thirdNiche || null, 
            coverLetter || null, resumePublicId || null, resumeUrl || null
        ];
    ...
    validateUserData(userData) {
        ...
        if (!userData.name || userData.name.length < 3 || userData.name.length > 30) {
        ...
        if (!userData.password || userData.password.length < 8 || userData.password.length > 32) {
        ...
        if (userData.role === 'Job Seeker' && (!userData.firstNiche || !userData.secondNiche || !userData.thirdNiche)) {
